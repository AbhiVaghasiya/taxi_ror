...
ActiveRecord::Schema.define(version: 2020_06_17_050006) do
  ...
  create_table "companies", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.decimal "alternate_mobile", precision: 10
    t.string "email"
  ...
  create_table "social_profiles", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
